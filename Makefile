...
memchr_avx2: memchr_avx2.o memchr_main.c
	$(CC) $(CFLAGS) -o memchr_avx2 memchr_avx2.o memchr_main.c $(AVX) 
...
memchr_glibc : memchr_glibc_O.o memchr_glibc_O2.o memchr_glibc_O3.o

memchr_simple : memchr_simple_O.o memchr_simple_O2.o memchr_simple_O3.o
