...
avx2_exe = "/home/kevin/coding/memchr_benchmark/parallel_bins/cancels/memchr_avx2_papi_virt"
...
# output writing
j = 0
with open('avx2_virtcyc_cancels_results.csv', 'a', newline='') as csv_file:
    csv_file.write("Executable,Threads,Buffer Size,Papi execution time,Userspace time,Kernel time,Max Resident Set Size,Page reclaims,\
Page faults,Papi Virtual Cycles,Block out ops,Voluntary Context Switches,Involuntary Context Switches,Time Stamp\n")
